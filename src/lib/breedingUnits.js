...
export const BREEDING_UNITS = [
  {
    ...
    breedingStatus: '사육중',
    initialRecords: [confirmedRecord('충만농장 2호', 'unit-chungman-202606', '2026-06-24', '2026년 6월', 2700000, 1350000)],
  },
  {
  ...
  },
  {
    ...
    breedingStatus: '사육중',
    initialRecords: [
      confirmedRecord('푸른농장 1호', 'unit-pureun-202603', '2026-03-08', '2026년 3월', 1800000, 900000),
      confirmedRecord('푸른농장 1호', 'unit-pureun-202603', '2026-03-08', '2026년 4월', 1850000, 925000),
      confirmedRecord('푸른농장 1호', 'unit-pureun-202603', '2026-03-08', '2026년 5월', 1900000, 950000),
    ],
  },
  {
    ...
    initialRecords: monthlyConfirmedRecords('충만농장 1호', 'unit-chungman-202509', '2024-06-01', 2024, 6, 24, 2400000, 1200000),
  },
]
