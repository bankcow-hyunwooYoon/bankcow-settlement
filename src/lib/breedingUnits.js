...
export const BREEDING_UNITS = [
  {
    ...
    breedingStatus: '사육중',
    initialRecords: [confirmedRecord('충만농장', 'unit-chungman-202606', '2026-06-24', '2026년 6월', 2700000, 1350000)],
  },
  {
  ...
  },
  {
    ...
    initialRecords: monthlyConfirmedRecords('충만농장', 'unit-chungman-202509', '2024-06-01', 2024, 6, 24, 2400000, 1200000),
  },
]
